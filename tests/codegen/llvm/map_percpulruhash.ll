...
!47 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 32, elements: !48)
!48 = !{!49}
...
!54 = distinct !DIGlobalVariable(name: "num_cpus", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
