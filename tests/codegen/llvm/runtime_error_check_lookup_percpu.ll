...
@num_cpus = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !44
...
event_loss_counter:                               ; preds = %helper_failure
  %10 = atomicrmw add ptr @event_loss_counter, i64 1 seq_cst, align 8
...
while_body:                                       ; preds = %while_cond
  ...
  %lookup_percpu_elem = call ptr inttoptr (i64 195 to ptr)(ptr @AT_, ptr %"@_key1", i32 %13)
...
error_success:                                    ; preds = %lookup_failure3
  ...
  %21 = getelementptr %helper_error_t, ptr %helper_error_t5, i64 0, i32 0
  store i64 30006, ptr %21, align 8
  %22 = getelementptr %helper_error_t, ptr %helper_error_t5, i64 0, i32 1
  store i64 1, ptr %22, align 8
  %23 = getelementptr %helper_error_t, ptr %helper_error_t5, i64 0, i32 2
...
event_loss_counter7:                              ; preds = %error_success
  %25 = atomicrmw add ptr @event_loss_counter, i64 1 seq_cst, align 8
...
!43 = distinct !DIGlobalVariable(name: "event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !27, isLocal: false, isDefinition: true)
!44 = !DIGlobalVariableExpression(var: !45, expr: !DIExpression())
!45 = distinct !DIGlobalVariable(name: "num_cpus", linkageName: "global", scope: !2, file: !2, type: !27, isLocal: false, isDefinition: true)
