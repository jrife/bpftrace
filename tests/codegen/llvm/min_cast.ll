...
while_body:                                       ; preds = %while_cond
  ...
  %lookup_percpu_elem = call ptr inttoptr (i64 195 to ptr)(ptr @AT_x, ptr %"@x_key3", i32 %13)
...
val_set_success:                                  ; preds = %lookup_success4
...
min_max_merge:                                    ; preds = %min_max_success, %ret_set_success, %lookup_success4
