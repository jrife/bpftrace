...
@num_cpus = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !63

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

define i64 @kprobe_f_1(ptr %0) section "s_kprobe_f_1" !dbg !68 {
entry:
  %"@x_val" = alloca i64, align 8
  %"@x_key1" = alloca i64, align 8
  %mm_struct = alloca %min_max_val, align 8
  %"@x_key" = alloca i64, align 8
  %mm_result = alloca i64, align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %mm_result)
...
lookup_failure:                                   ; preds = %entry
  ...
  store i64 2, ptr %mm_result, align 8
...
lookup_merge:                                     ; preds = %lookup_failure, %min_max, %is_set
  %7 = load i64, ptr %mm_result, align 8
...
define internal i64 @map_for_each_cb(ptr %0, ptr %1, ptr %2, ptr %3) section ".text" !dbg !74 {
  %"$res" = alloca i64, align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"$res")
  store i64 0, ptr %"$res", align 8
  %"$kv" = alloca %int64_min_t__tuple_t, align 8
...
while_end:                                        ; preds = %error_failure, %error_success, %while_cond
  ...
  %9 = getelementptr %int64_min_t__tuple_t, ptr %"$kv", i32 0, i32 0
  store i64 %key, ptr %9, align 8
  %10 = getelementptr %int64_min_t__tuple_t, ptr %"$kv", i32 0, i32 1
  store i64 %8, ptr %10, align 8
  %11 = getelementptr %int64_min_t__tuple_t, ptr %"$kv", i32 0, i32 1
...
!62 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !2, file: !2, baseType: !23, size: 64, offset: 192)
!63 = !DIGlobalVariableExpression(var: !64, expr: !DIExpression())
!64 = distinct !DIGlobalVariable(name: "num_cpus", linkageName: "global", scope: !2, file: !2, type: !24, isLocal: false, isDefinition: true)
!65 = distinct !DICompileUnit(language: DW_LANG_C, file: !2, producer: "bpftrace", isOptimized: false, runtimeVersion: 0, emissionKind: LineTablesOnly, globals: !66)
!66 = !{!0, !7, !32, !46, !63}
!67 = !{i32 2, !"Debug Info Version", i32 3}
!68 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !69, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !65, retainedNodes: !72)
...
!74 = distinct !DISubprogram(name: "map_for_each_cb", linkageName: "map_for_each_cb", scope: !2, file: !2, type: !75, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !65, retainedNodes: !77)
