...
@event_loss_counter = dso_local externally_initialized global i64 0, section ".data.event_loss_counter", !dbg !62
...
merge:                                            ; preds = %maybe_clear
  %5 = load ptr, ptr %ts_struct_ptr, align 8
  %6 = getelementptr %t_series_val, ptr %5, i64 0, i32 1
...
lookup_failure:                                   ; preds = %entry
  ...
  %8 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 0
  store i64 0, ptr %8, align 8
  %9 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 1
  store i64 0, ptr %9, align 8
  %10 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 2
  store i64 0, ptr %10, align 8
  store ptr %ts_struct, ptr %ts_struct_ptr, align 8
  br label %maybe_clear

lookup_success3:                                  ; preds = %merge
  %11 = load i64, ptr %lookup_elem2, align 8
  store i64 %11, ptr %lookup_elem_val, align 8
...
lookup_merge:                                     ; preds = %lookup_failure4, %lookup_success3
  %12 = load i64, ptr %lookup_elem_val, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %lookup_elem_val)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@a_key1")
  %13 = getelementptr %t_series_val, ptr %5, i64 0, i32 0
  store i64 %12, ptr %13, align 8
  %14 = getelementptr %t_series_val, ptr %5, i64 0, i32 1
  store i64 %get_ns, ptr %14, align 8
  %15 = getelementptr %t_series_val, ptr %5, i64 0, i32 2
  store i64 %1, ptr %15, align 8
  %update_elem6 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %"@x_key", ptr %5, i64 0)
...
!46 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !47, size: 64, offset: 64)
...
!63 = distinct !DIGlobalVariable(name: "event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
