...
@AT_x = dso_local global %"struct map_t.0" zeroinitializer, section ".maps", !dbg !22
@ringbuf = dso_local global %"struct map_t.1" zeroinitializer, section ".maps", !dbg !38
...
entry:
  ...
  %lookup_elem = call ptr inttoptr (i64 1 to ptr)(ptr @AT_a, ptr %"@a_key1")
  call void @llvm.lifetime.start.p0(i64 -1, ptr %lookup_elem_val)
  %map_lookup_cond = icmp ne ptr %lookup_elem, null
  br i1 %map_lookup_cond, label %lookup_success, label %lookup_failure

merge:                                            ; preds = %lookup_failure4, %lookup_success3
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %3 = udiv i64 %get_ns, 1000000000
  %4 = urem i64 %3, 20
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@x_key")
  store i64 %4, ptr %"@x_key", align 8
  %lookup_elem2 = call ptr inttoptr (i64 1 to ptr)(ptr @AT_x, ptr %"@x_key")
...
lookup_success3:                                  ; preds = %lookup_merge
  %5 = getelementptr %t_series_val, ptr %lookup_elem2, i64 0, i32 0
  %6 = load i64, ptr %value, align 8
  store i64 %6, ptr %5, align 8
  %7 = getelementptr %t_series_val, ptr %lookup_elem2, i64 0, i32 1
  store i64 %get_ns, ptr %7, align 8
  %8 = getelementptr %t_series_val, ptr %lookup_elem2, i64 0, i32 2
  store i64 %3, ptr %8, align 8
  br label %merge

lookup_failure4:                                  ; preds = %lookup_merge
  call void @llvm.lifetime.start.p0(i64 -1, ptr %ts_struct)
  %9 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 0
  %10 = load i64, ptr %value, align 8
  store i64 %10, ptr %9, align 8
  %11 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 1
  store i64 %get_ns, ptr %11, align 8
  %12 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 2
  store i64 %3, ptr %12, align 8
  %update_elem6 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %"@x_key", ptr %ts_struct, i64 0)
...
!28 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 640, elements: !29)
!29 = !{!30}
!30 = !DISubrange(count: 20, lowerBound: 0)
...
!34 = !{!35, !36, !35}
!35 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !20, size: 64)
!36 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !37, size: 64, offset: 64)
...
!44 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 864, elements: !45)
!45 = !{!46}
...
!49 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 8388608, elements: !50)
!50 = !{!51}
...
!58 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 64, elements: !59)
!59 = !{!60}
!60 = !DISubrange(count: 2, lowerBound: 0)
!61 = !DIDerivedType(tag: DW_TAG_member, name: "key", scope: !2, file: !2, baseType: !62, size: 64, offset: 128)
