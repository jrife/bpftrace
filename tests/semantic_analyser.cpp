...
config = { enable_tseries = 1 } kprobe:f { @ = tseries(5, "10s", 1, 10); }
  ...
  test_error(
      ...
      R"(
stdin:1:44-64: ERROR: tseries() must be assigned directly to a map
config = { enable_tseries = 1 } kprobe:f { tseries(5, "10s", 1); }
                                           ~~~~~~~~~~~~~~~~~~~~
)");
  test_error("config = { enable_tseries = 1 } kprobe:f { $x = tseries(); }", R"(
stdin:1:49-58: ERROR: tseries() must be assigned directly to a map
config = { enable_tseries = 1 } kprobe:f { $x = tseries(); }
                                                ~~~~~~~~~
)");
  test_error("config = { enable_tseries = 1 } kprobe:f { @[tseries()] = 1; }",
             R"(
stdin:1:44-55: ERROR: tseries() must be assigned directly to a map
config = { enable_tseries = 1 } kprobe:f { @[tseries()] = 1; }
  ...
  test_error(
      ...
      R"(
stdin:1:44-56: ERROR: tseries() must be assigned directly to a map
config = { enable_tseries = 1 } kprobe:f { if(tseries()) { 123 } }
                                           ~~~~~~~~~~~~
)");
  test_error("config = { enable_tseries = 1 } kprobe:f { tseries() ? 0 : 1; }",
             R"(
stdin:1:44-53: ERROR: tseries() must be assigned directly to a map
...
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10s", 1000001); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-67: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("10" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-68: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("10m" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10m", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-68: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("10h" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10h", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-68: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("10d" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10d", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-71: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("10s5ns" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "10s5ns", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-67: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("ns" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "ns", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-67: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("us" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "us", 5); }
  ...
  test_error(
      ...
      "5); }",
      R"(
stdin:1:48-67: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("ms" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "ms", 5); }
  ...
  test_error("config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, \"s\", "
             "5); }",
             R"(
stdin:1:48-66: ERROR: tseries() expects an interval of format ^[1-9][0-9]{0,2}[num]?s+$ ("s" provided)
config = { enable_tseries = 1 } kprobe:f { @ = tseries(1, "s", 5); }
  ...
  test_error("config = { enable_tseries = 1 } kprobe:f { @ = tseries(stats(1), "
             "\"10s\", 5); }",
             R"(
stdin:1:48-75: ERROR: tseries() value must be an integer or a call to avg, count, max, min, or sum
config = { enable_tseries = 1 } kprobe:f { @ = tseries(stats(1), "10s", 5); }
  ...
  test_error(
      ...
      "10, 1), \"10s\", 5); }",
      R"(
stdin:1:48-85: ERROR: tseries() value must be an integer or a call to avg, count, max, min, or sum
config = { enable_tseries = 1 } kprobe:f { @ = tseries(lhist(5, 0, 10, 1), "10s", 5); }
  ...
  test_error("config = { enable_tseries = 1 } kprobe:f { @v = count(); @ = "
             "tseries(@v, \"10s\", 5); }",
             R"(
stdin:1:62-83: ERROR: tseries() value must be an integer or a call to avg, count, max, min, or sum
config = { enable_tseries = 1 } kprobe:f { @v = count(); @ = tseries(@v, "10s", 5); }
  ...
  test_error("config = { enable_tseries = 1 } kprobe:f { @v = sum(5); @ = "
             "tseries(@v, \"10s\", 5); }",
             R"(
stdin:1:61-82: ERROR: tseries() value must be an integer or a call to avg, count, max, min, or sum
...
BEGIN { @a = lhist(123, 0, 123, 1); let $b = @a; }
  ...
  test_error("config = { enable_tseries = 1 } BEGIN { @a = tseries(10, "
             "\"10s\", 1); let $b = @a; }",
             R"(
stdin:1:69-80: ERROR: Value 'tseries_t' cannot be assigned to a scratch variable.
config = { enable_tseries = 1 } BEGIN { @a = tseries(10, "10s", 1); let $b = @a; }
                                                                    ~~~~~~~~~~~
stdin:1:69-75: WARNING: Variable $b never assigned to.
config = { enable_tseries = 1 } BEGIN { @a = tseries(10, "10s", 1); let $b = @a; }
                                                                    ~~~~~~
)");
...
BEGIN { @a = lhist(123, 0, 123, 1); @b = @a; }
  ...
  test_error("config = { enable_tseries = 1 } BEGIN { @a = tseries(10, "
             "\"10s\", 1); @b = @a; }",
             R"(
stdin:1:69-76: ERROR: Map value 'tseries_t' cannot be assigned from one map to another. The function that returns this type must be called directly e.g. `@b = tseries(rand %10, "10s", 1);`.
